...
for idx in tqdm(range(len(test_ds))):
    with torch.no_grad():
        ...
        # print (f"for frame {frame_num}, it took {time.time() - start_t} ")
        ...
        total_time_with_visual += time.time() - start_t

    frame_num += 1

print ("Total_time is: ", total_t)
print ("Total_time with visualization", total_time_with_visual)
print ("Total_frame num is: ", frame_num)
 
print ("average time per frame is: ",total_t / frame_num)
print("FPS is: ", 1 / (total_t / frame_num))

print ("average time with visualization per frame is: ",total_time_with_visual / frame_num)
print("FPS with visual is: ", 1 / (total_time_with_visual / frame_num))
if MEAS_RESULT:
    print("Final results:")
    if dataset == "kitti_odometry":
